...
function dy(code){
	...
	if(code=="tb960x90"){
		document.writeln('<div align="center" class="tb960x90"><a target="_blank" href="http://js.50bang.org/?formType=6029"><img src="http://www.17sucai.com/static/images/960x90.gif" width="960" height="90" /></a></div>')		
	}
...
a.offsetWidth,e=a.offsetHeight,g=a.nodeName.toLowerCase()==="tr";return b===0&&e===0&&!g?true:b>0&&e>0&&!g?false:c.curCSS(a,"display")==="none"};c.expr.filters.visible=function(a){return!c.expr.filters.hidden(a)}}var tb=z(),ub=//gi,vb=/select|textarea/i,wb=/color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week/i,ca=/=\?(&|$)/,Aa=/\?/,xb=/(\?|&)_=.*?(&|$)/,yb=/^(\w+:)?\/\/([^\/?#]+)/,zb=/%20/g,Ab=c.fn.load;c.fn.extend({load:function(a,b,
